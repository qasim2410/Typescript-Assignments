...
const myFriends: string[] = ["Qasim","Hussain","Muneeb","Huzaifa","Akkasha","Furqan"];
console.log(`This is not available i can invite only 2 person`);

//remove all three last elements
